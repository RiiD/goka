...
// Source: github.com/lovoo/goka (interfaces: TopicManager,Producer,Broker,Codec)
...
func (m *MockProducer) Emit(arg0 string, arg1, arg2 []byte) *Promise {
	m.ctrl.T.Helper()
...
func (m *MockCodec) Decode(arg0 []byte) (interface{}, error) {
	m.ctrl.T.Helper()
